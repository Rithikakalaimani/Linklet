  ...
  return (
    <div className='max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12'>
      ...
      <div className='bg-gray-900 rounded-lg shadow-lg p-4 sm:p-6 mb-6 sm:mb-8 border border-gray-800'>
        <h2 className='text-lg sm:text-xl font-bold text-gray-100 mb-4 sm:mb-6'>
          Visits & Visitors Analysis
        </h2>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8'>
        <div className='h-full'>
          <AnalyticsPieChart data={clicksByBrowser} title='Clicks by Browser' />
        </div>

        <div className='h-full'>
          <AnalyticsPieChart data={clicksByOS} title='Clicks by OS' />
        </div>

        <div className='h-full md:col-span-2 lg:col-span-1'>
          <AnalyticsPieChart data={clicksByDevice} title='Clicks by Device' />
        </div>
      </div>
            ...
            <div className='overflow-hidden'>
              <table className='min-w-full divide-y divide-gray-800'>
                <thead className='bg-gray-800'>
                  <tr>
                    <th className='px-3 sm:px-4 py-2 sm:py-3 text-left text-xs font-medium text-gray-400 uppercase'>
                      Timestamp
                    </th>
                    <th className='px-3 sm:px-4 py-2 sm:py-3 text-left text-xs font-medium text-gray-400 uppercase hidden md:table-cell'>
                      Browser
                    </th>
                    <th className='px-3 sm:px-4 py-2 sm:py-3 text-left text-xs font-medium text-gray-400 uppercase hidden lg:table-cell'>
                      OS
                    </th>
                    <th className='px-3 sm:px-4 py-2 sm:py-3 text-left text-xs font-medium text-gray-400 uppercase'>
                      Device
                    </th>
                    <th className='px-3 sm:px-4 py-2 sm:py-3 text-left text-xs font-medium text-gray-400 uppercase hidden xl:table-cell'>
                      Location
                    </th>
                    <th className='px-3 sm:px-4 py-2 sm:py-3 text-left text-xs font-medium text-gray-400 uppercase hidden lg:table-cell'>
                      Referer
